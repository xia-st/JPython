...
public final class GramInit{
    ...
    public static DFA[] dfas = {
        ...
        new DFA(DFAName.eval_input, 0, 3, GramInit.states_2, jumpedDFAs_2),
        new DFA(DFAName.decorator, 0, 6, GramInit.states_3, jumpedDFAs_4),
        ...
        new DFA(DFAName.typedargslist, 0, 12, GramInit.states_9, jumpedDFAs_9),
        new DFA(DFAName.tfpdef, 0, 4, GramInit.states_10, jumpedDFAs_10),
        new DFA(DFAName.varargslist, 0, 12, GramInit.states_11, jumpedDFAs_11),
        new DFA(DFAName.vfpdef, 0, 2, GramInit.states_12, jumpedDFAs_12),
        new DFA(DFAName.stmt, 0, 2, GramInit.states_13, jumpedDFAs_13),
        new DFA(DFAName.simple_stmt, 0, 4, GramInit.states_14, jumpedDFAs_14),
        new DFA(DFAName.small_stmt, 0, 2, GramInit.states_15, jumpedDFAs_15),
        new DFA(DFAName.expr_stmt, 0, 6, GramInit.states_16, jumpedDFAs_16),
        new DFA(DFAName.testlist_star_expr, 0, 3, GramInit.states_17, jumpedDFAs_68),
        ...
        new DFA(DFAName.import_as_names, 0, 3, GramInit.states_32, jumpedDFAs_32),
        ...
        new DFA(DFAName.try_stmt, 0, 10, GramInit.states_43, jumpedDFAs_43),
        ...
        new DFA(DFAName.atom, 0, 7, GramInit.states_67, jumpedDFAs_67),
        new DFA(DFAName.testlist_comp, 0, 5, GramInit.states_68, jumpedDFAs_68),
        new DFA(DFAName.trailer, 0, 7, GramInit.states_69, jumpedDFAs_69),
        new DFA(DFAName.subscriptlist, 0, 3, GramInit.states_70, jumpedDFAs_70),
        ...
        new DFA(DFAName.exprlist, 0, 3, GramInit.states_73, jumpedDFAs_73),
        new DFA(DFAName.testlist, 0, 3, GramInit.states_74, jumpedDFAs_74),
        new DFA(DFAName.dictorsetmaker, 0, 14, GramInit.states_75, jumpedDFAs_75),
        new DFA(DFAName.classdef, 0, 6, GramInit.states_76, jumpedDFAs_76),
        new DFA(DFAName.arglist, 0, 3, GramInit.states_77, jumpedDFAs_77),
        new DFA(DFAName.argument, 0, 4, GramInit.states_78, jumpedDFAs_78),
