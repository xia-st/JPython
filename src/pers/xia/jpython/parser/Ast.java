...
import pers.xia.jpython.ast.Assert;
import pers.xia.jpython.ast.Assign;
import pers.xia.jpython.ast.AsyncFor;
import pers.xia.jpython.ast.AsyncFunctionDef;
import pers.xia.jpython.ast.AsyncWith;
import pers.xia.jpython.ast.Attribute;
import pers.xia.jpython.ast.AugAssign;
import pers.xia.jpython.ast.Await;
import pers.xia.jpython.ast.BinOp;
import pers.xia.jpython.ast.BoolOp;
import pers.xia.jpython.ast.Break;
import pers.xia.jpython.ast.Bytes;
import pers.xia.jpython.ast.Call;
import pers.xia.jpython.ast.ClassDef;
import pers.xia.jpython.ast.Compare;
import pers.xia.jpython.ast.Continue;
import pers.xia.jpython.ast.Delete;
import pers.xia.jpython.ast.Dict;
import pers.xia.jpython.ast.DictComp;
import pers.xia.jpython.ast.Ellipsis;
import pers.xia.jpython.ast.ExceptHandler;
import pers.xia.jpython.ast.Expr;
import pers.xia.jpython.ast.Expression;
import pers.xia.jpython.ast.ExtSlice;
import pers.xia.jpython.ast.For;
import pers.xia.jpython.ast.FunctionDef;
import pers.xia.jpython.ast.GeneratorExp;
import pers.xia.jpython.ast.Global;
import pers.xia.jpython.ast.If;
import pers.xia.jpython.ast.IfExp;
import pers.xia.jpython.ast.Import;
import pers.xia.jpython.ast.ImportFrom;
import pers.xia.jpython.ast.Index;
import pers.xia.jpython.ast.Interactive;
import pers.xia.jpython.ast.Lambda;
import pers.xia.jpython.ast.List;
import pers.xia.jpython.ast.ListComp;
import pers.xia.jpython.ast.Module;
import pers.xia.jpython.ast.Name;
import pers.xia.jpython.ast.NameConstant;
import pers.xia.jpython.ast.Nonlocal;
import pers.xia.jpython.ast.Num;
import pers.xia.jpython.ast.Pass;
import pers.xia.jpython.ast.Raise;
import pers.xia.jpython.ast.Return;
import pers.xia.jpython.ast.Set;
import pers.xia.jpython.ast.SetComp;
import pers.xia.jpython.ast.Slice;
import pers.xia.jpython.ast.Starred;
import pers.xia.jpython.ast.Str;
import pers.xia.jpython.ast.Subscript;
import pers.xia.jpython.ast.Try;
import pers.xia.jpython.ast.Tuple;
import pers.xia.jpython.ast.UnaryOp;
import pers.xia.jpython.ast.While;
import pers.xia.jpython.ast.With;
import pers.xia.jpython.ast.Yield;
import pers.xia.jpython.ast.YieldFrom;
import pers.xia.jpython.ast.aliasType;
import pers.xia.jpython.ast.argType;
import pers.xia.jpython.ast.argumentsType;
import pers.xia.jpython.ast.boolopType;
import pers.xia.jpython.ast.cmpopType;
import pers.xia.jpython.ast.comprehensionType;
import pers.xia.jpython.ast.excepthandlerType;
import pers.xia.jpython.ast.exprType;
import pers.xia.jpython.ast.expr_contextType;
import pers.xia.jpython.ast.keywordType;
import pers.xia.jpython.ast.modType;
import pers.xia.jpython.ast.operatorType;
import pers.xia.jpython.ast.sliceType;
import pers.xia.jpython.ast.stmtType;
import pers.xia.jpython.ast.unaryopType;
import pers.xia.jpython.ast.withitemType;
